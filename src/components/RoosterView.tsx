  ...
  return (
    <div style={{ padding: "1.5rem", maxWidth: "900px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
        <button onClick={() => setJaar(j => j - 1)} style={navBtn}>◀</button>
        <h2 style={{ margin: 0, fontSize: "1.4rem" }}>📅 Rooster {jaar}</h2>
        <button onClick={() => setJaar(j => j + 1)} style={navBtn}>▶</button>
      </div>
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          background: isHuidig ? "#2196F3" : "#f0f0f0",
                          color: isHuidig ? "white" : "#333",
                          cursor: "pointer", fontSize: "0.8rem", fontWeight: isHuidig ? "bold" : "normal",
                        }}
                      >
                        W{week}
                      </button>
